...
export class Backend implements backendInterface {
    ...
    async addQuestion(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
    ...
    async calculatePrakruti(arg0: Array<bigint>): Promise<QuizResult> {
        if (this.processError) {
            try {
                const result = await this.actor.calculatePrakruti(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
